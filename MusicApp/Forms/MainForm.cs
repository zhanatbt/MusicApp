...
namespace MusicApp.Forms
{
        public class MainForm : Form
    {
        ...
        // ИСПРАВЛЕНИЕ: храним полный список с PlaylistTrackId
        ...
        private void BuildUI()
        {
            ...
            _dgvTracks.Columns.AddRange(
                ...
                new DataGridViewTextBoxColumn { HeaderText = "Исполнитель",  DataPropertyName = "ArtistName",       Width = 140 },
                ...
                new DataGridViewTextBoxColumn { HeaderText = "Длит.",        DataPropertyName = "DurationFormatted", Width = 60 }
            );
 
            leftPanel.Controls.Add(_dgvTracks);
            leftPanel.Controls.Add(searchPanel);
 
            // ── Правая панель: плейлисты + плеер ──────────────────────
            ...
            _dgvPlaylist.Columns.AddRange(
                ...
                new DataGridViewTextBoxColumn { HeaderText = "Исполнитель", DataPropertyName = "ArtistName",        Width = 110 },
            ...
            _btnPlay = new Button
            {
                Text = "▶ Воспроизвести плейлист", Width = 175, Height = 26,
        ...
        private void LoadFilters()
        {
            ...
            var artists = MusicApp.Program.Services
                            .GetRequiredService<IArtistService>().GetAll();
        ...
        {
            // ИСПРАВЛЕНИЕ: используем GetTracksWithIds — получаем PlaylistTrackId через сервис,
            // без прямого обращения к DbContext из UI.
        ...
        private void OnNewPlaylist(object sender, EventArgs e)
        {
            string name = Microsoft.VisualBasic.Interaction.InputBox(
                "Название нового плейлиста:", "Новый плейлист");
        ...
        {
            // ИСПРАВЛЕНИЕ: читаем PlaylistTrackId напрямую из выбранной строки,
            // больше не нужно лезть в DbContext из UI-слоя.
